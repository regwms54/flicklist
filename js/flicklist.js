...
var api = {
  ...
  token: "ef40295a950b21df1f35e557984c6e36", // TODO 0 add your api key (DONE)
...
function render() {
  ...
  model.watchlistItems.forEach(function(movie) {
    ...
    var button = $("<button></button>")
      ...
      .click(function() {
        var movie_idx = model.watchlistItems.indexOf(movie);
        model.watchlistItems.splice(movie_idx, 1);
        render();
      });
